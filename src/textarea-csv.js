/**
 * textarea-csv wraps a textarea providing a table like editable experience.
 */

import * as csv from "@std/csv";

export class TextareaCSV extends HTMLElement {
  constructor() {
    super();
...
export function parseCSVRow(csvRowString) {
  const data = csv.parse(csvRowString)
  return data[0];
}
 ...
 */
export function stringifyCSVRow(row) {
