        ...
        <footer class="footer-container" role="contentinfo">
            ...
            <div class="footer-column column2">
                ...
                <div class="social">
                    ...
                    <a id="twitter-link"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16" role="img" aria-labelledby="cl-tw-f">
  ...
  connectedCallback() {
    ...
    // Listen for slot content changes and show fallback if nexessary
      ...
      fallback.setAttribute("aria-hidden", hasContent ? "true" : "false");
		...
		const twitterAnchor = this.shadowRoot.getElementById("twitter-link");
    const youtubeAnchor = this.shadowRoot.getElementById("youtube-link");
		...
		const twitterHref = this.getAttribute("twitter") || "https://twitter.com/caltechlibrary";
    const youtubeHref = this.getAttribute("twitter") || "https://www.youtube.com/channel/UCQbC4mcNNqypGMRtjgcN0SA";
		...
		if (twitterAnchor) twitterAnchor.setAttribute("href", twitterHref);
