import { parseCSV, parseCSVRow, stringifyCSV } from "./textarea-csv.js";
...
/*
// Test the TextareaCSV class
test("TextareaCSV Test", () => {
  const TextareaCSV = new TextareaCSV();
  TextareaCSV.setAttribute('column-headings', 'Column1, Column2');

  assertEquals(TextareaCSV instanceof HTMLElement, true, "Component is an instance of HTMLElement");
  assertEquals(TextareaCSV.hasAttribute('column-headings'), true, "Component has column-headings attribute");
});
*/
